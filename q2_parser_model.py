...
class ParserModel(Model):
    ...
    def add_embedding(self):
        ...
        """
        ### YOUR CODE HERE
        trained_embeddings = tf.Variable(initial_value=self.pretrained_embeddings)
        raw_embeddings = tf.nn.embedding_lookup(trained_embeddings, self.input_placeholder)
        embeddings = tf.reshape(raw_embeddings, [-1, Config.n_features * Config.embed_size])
        ### END YOUR CODE
        return embeddings
    ...
    def add_prediction_op(self):
        ...
        self.W = xavier_initializer((Config.n_features * Config.embed_size, Config.hidden_size))
        self.U = xavier_initializer((Config.hidden_size, Config.n_classes))
        self.b1 = xavier_initializer((1, Config.hidden_size))
        self.b2 = xavier_initializer((1, Config.n_classes))
    ...
    def add_training_op(self, loss):
        ...
        train_op = optimizer.minimize(loss, var_list=[self.W, self.U, self.b1, self.b2])
        ### END YOUR CODE
        return train_op
